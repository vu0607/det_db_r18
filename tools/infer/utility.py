...
def init_args():
    ...
    parser.add_argument("--min_subgraph_size", type=int, default=30)
    ...
    # DB parmas
    parser.add_argument("--det_db_thresh", type=float, default=0.8)
    parser.add_argument("--det_db_box_thresh", type=float, default=0.85)
    ...
    parser.add_argument("--rec_url", type=str)
    parser.add_argument("--rec_image_shape", type=str, default="3, 32, 512")
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default="./ppocr/utils/dict/vietnamese_dict.txt")
    ...
    parser.add_argument("--logging_time", type=str2bool, default=False)
