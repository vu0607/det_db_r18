...
class PVAM(nn.Layer):
    def __init__(self, in_channels, char_num, max_text_length, num_heads,
                 num_encoder_tus, hidden_dims, drop_out=0.1):
        ...
        self.wrap_encoder_for_feature = WrapEncoderForFeature(
            ...
            prepostprocess_dropout=drop_out,
            attention_dropout=drop_out,
            relu_dropout=drop_out,
            preprocess_cmd="n",
            postprocess_cmd="da",
            weight_sharing=True)
...
class GSRM(nn.Layer):
    def __init__(self, in_channels, char_num, max_text_length, num_heads,
                 num_encoder_tus, num_decoder_tus, hidden_dims, drop_out=0.1):
...
class SRNHead(nn.Layer):
    def __init__(self, in_channels, out_channels, max_text_length, num_heads,
                 num_encoder_TUs, num_decoder_TUs, hidden_dims, drop_out=0.1, **kwargs):
